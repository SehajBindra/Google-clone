  ...
  return (
    <>
      ...
      <div className=" flex flex-col justify-center items-center min-h-screen py-2  px-14 text-center bg-black">
        ...
        <p className="font-xs text-white">Welcome to the Google clone .</p>
          ...
          {providers &&
            Object.values(providers).map((provider) => (
              <div className="flex flex-col items-center" key={provider.name}>
                <button
                  className=" flex items-center p-3 px-5 py-5 text-lg  ring-gray-300 ring-1  rounded-full text-white "
