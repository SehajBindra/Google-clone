...
function Header() {
  ...
  return (
    <header className="sticky top-0 bg-white text-black dark:bg-black dark:text-white">
      <div className="flex  w-full p-4 items-center dark:bg-black dark:text-white">
        <Image
          onClick={() => router.push("/")}
        ...
        <form className="flex border border-gray-200 max-w-3xl flex-grow rounded-full px-1 py-3 ml-8 mr-5 shadow-lg items-center dark:bg-black  ">
          <input
            className="flex-grow w-full focus:outline-none ml-3 dark:text-white dark:bg-black"
            ref={SearchInputRef}
            type="text"
          />
          <XIcon
        ...
        <div className="flex ml-auto space-x-3 items-center ">
          ...
          <MoonIcon
            ...
            className="h-10 cursor-pointer rounded-full hover:bg-gray-100"
          />{" "}
          :{" "}
          <SunIcon
            onClick={() => setTheme("light")}
            className="h-10 rounded-full  cursor-pointer hover:bg-gray-100"
          />
