  ...
  return (
    <header className="sticky top-0 bg-white">
      <div className="flex w-full p-6 items-center">
        ...
        {/* settings Icon */}
        <img
          className=" hidden h-6 w-6 text-gray-500 cursor-pointer rounded-full hover: bg-gray-100 sm:inline-flex"
        ...
        {/* Apps Icon */}
        <img
          className="h-6 w-6 cursor-pointer rounded-full hover: bg-gray-100"
          src="/images/apps.svg"
          alt=""
        />
